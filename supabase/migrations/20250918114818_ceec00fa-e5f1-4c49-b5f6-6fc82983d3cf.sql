-- Let's create demo data that works without foreign key constraints
-- We'll insert minimal data first

-- Insert some series without creator dependencies for now
