...
VALUES (
    '140242e4-b30c-412d-8753-53532e00d601',
    'admin_creator',
    'Featured Content Creator',
    'Creator of featured series content',
    now(),
    now()
) ON CONFLICT (id) DO NOTHING;

-- Create creator profile
INSERT INTO public.creators (id, user_id, bio, verified, created_at, updated_at) 
VALUES (
    gen_random_uuid(), 
    '140242e4-b30c-412d-8753-53532e00d601', 
    'Creator of featured content series', 
    true,
    now(),
    now()
...
BEGIN
    ...
    INSERT INTO public.series (id, creator_id, title, description, status, genre, language, vertical_thumbnail_url, created_at, updated_at)
    VALUES (
        gen_random_uuid(),
        creator_uuid,
        'Toxic Boy friend',
    ...
    INSERT INTO public.episodes (series_id, title, description, video_url, episode_number, status, duration, thumbnail_url, created_at, updated_at)
    VALUES 
    (
        series_uuid,
    ...
    -- Update series episode count and views
