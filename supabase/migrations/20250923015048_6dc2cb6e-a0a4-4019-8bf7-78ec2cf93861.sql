-- Create the Auto Johny S1 series and episodes

-- First, ensure there's a creator profile (this will be idempotent)
INSERT INTO public.creators (user_id, bio, verified, follower_count, created_at, updated_at)
SELECT auth.uid(), 'Content Creator', false, 0, now(), now()
WHERE NOT EXISTS (
